...
- [x] **Diagnostics** (live ESTOP, ALM, DIR switch, pedal switch, ENA, direction, RPM, motion-block state)
...
### Documentation
- [x] **README** (v2.0.5, feature list, wiring diagram, BOM; synced with `config.h`)
