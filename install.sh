...
TEMP_EXTRACT_DIR="$HOME/.local/share/cursor-agent/versions/.tmp-2026.04.17-787b533-$(date +%s)"
...
DOWNLOAD_URL="https://downloads.cursor.com/lab/2026.04.17-787b533/${OS}/${ARCH}/agent-cli-package.tar.gz"
...
FINAL_DIR="$HOME/.local/share/cursor-agent/versions/2026.04.17-787b533"
...
ln -s ~/.local/share/cursor-agent/versions/2026.04.17-787b533/cursor-agent ~/.local/bin/agent
ln -s ~/.local/share/cursor-agent/versions/2026.04.17-787b533/cursor-agent ~/.local/bin/cursor-agent
